...
class CADOMDVRPRunConfig(Schema):
    """Top-level config for ``cado.mdvrp.main.run_train``."""
    ...
    @classmethod
    def from_hydra(cls, cfg: DictConfig) -> "CADOMDVRPRunConfig":
    ...
    def wandb_run_name(self) -> str:
        ...
        return (
            f"cado_{self.cado.algorithm}_mdvrp{self.data.num_customers}"
