...
from cado.cvrp.main.train_rf import CVRPInstance
...
def collect_trajectory(
    ...
    node_feat, edge_index, edge_dist, _, _ = instance
...
def ppo_outer_step(
    ...
    *,
    ...
    for instance in batch:
        node_feat, edge_index, edge_dist, edge_label, capacity = [
            t.to(device) for t in instance
        ]
        cap = _capacity_scalar(capacity)
