...
``{checkpoint_dir}/cado_tsp_YYYYMMDD_HHMMSS/best_model.pt``.
"""
...
from utils import CADO_TSP, best_model_path, resolve_pretrained, run_dir, select_device
...
def _load_pretrained(model: CADOTSP, ckpt_path: Path) -> dict:
...
def main(hydra_cfg: DictConfig) -> None:
    ...
    ckpt_dir = run_dir(cfg.checkpoint_dir, CADO_TSP, cwd=project_root, mkdir=True)
